VendorAttack.Game = function(game) {
/*    this.totalBunnies;
    this.bunnyGroup;
...
VendorAttack.Game.prototype = {
    ...
    buildWorld: function() {
        var img = this.add.image(this.world.centerX, this.world.centerY, 'sky');
         img.anchor.setTo(0.5, 0.5);
         img.scale = new PIXI.Point(this.game.width/img.width, this.game.height/img.height); //UGLY HACK
